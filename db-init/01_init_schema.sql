...
(1, '2022-06-30', 'Visit', 'Cardiology', 'Annual follow-up. BP 128/82 mmHg. Denies chest pain. Pedal edema +1 bilaterally.', 'Possible statin myopathy', 'CPK: 210 U/L (normal). Continue Atorvastatin. Add compression stockings'),
(1, '2022-11-18', 'Lab', 'Cardiology', 'Lipid panel: LDL 78, HDL 42, Trig 150. Liver enzymes normal.', 'Goal LDL achieved', 'Continue current therapy. Next follow-up 6 months');
-- (1, '2023-03-10', 'Visit', 'Cardiology', 'Reports new palpitations - rapid irregular heartbeat lasting 10-15 minutes. No syncope.', 'Suspected paroxysmal AF', 'Ordered: Event monitor for 2 weeks'),
-- (1, '2023-03-25', 'Procedure', 'Cardiology', 'Event monitor results: Episode of atrial fibrillation lasting 18 minutes. Average HR 110 bpm during episode.', 'Paroxysmal atrial fibrillation', 'Started: Apixaban 5mg BID. Added: Metoprolol 25mg daily'),
-- (1, '2023-07-18', 'Visit', 'Cardiology', 'Follow-up for AF. Reports 2 brief palpitation episodes. BP 130/80 mmHg. INR not applicable (on DOAC).', 'Controlled paroxysmal AF', 'Continue current regimen. Consider ablation if frequency increases'),
-- (1, '2024-01-12', 'Visit', 'Cardiology', 'Increased AF episodes to 3-4 weekly. Reports fatigue. BP 140/86 mmHg.', 'Progressive atrial fibrillation', 'Increased: Metoprolol to 50mg daily. Scheduled cardioversion'),
-- (1, '2024-02-01', 'Procedure', 'Cardiology', 'Electrical cardioversion: 200J synchronized shock. Immediate restoration of sinus rhythm.', 'Successful cardioversion', 'Post-procedure: Monitor for recurrence. Continue anticoagulation'),
-- (1, '2024-03-15', 'Visit', 'Cardiology', '3-week post-cardioversion. No AF recurrence. Reports improved energy levels.', 'Stable sinus rhythm', 'Continue: Apixaban 5mg BID, Metoprolol 50mg daily'),
-- (1, '2024-05-10', 'Imaging', 'Cardiology', 'Transesophageal echocardiogram: No atrial thrombus. Mild left atrial enlargement. LVEF 55%.', 'Persistent left atrial remodeling', 'Continue current management. Consider long-term antiarrhythmics'),
-- (1, '2024-06-01', 'Lab', 'Cardiology', 'Renal function: eGFR 68 mL/min. Liver enzymes normal. CBC: Hgb 14.2, platelets 210K.', 'Mild renal impairment', 'Adjust: Apixaban to 2.5mg BID due to renal function'),
-- (1, '2024-06-15', 'Procedure', 'Cardiology', '24-hour Holter monitor: Sinus rhythm with rare PACs (total 78). No AF recurrence.', 'Controlled arrhythmia', 'Continue current regimen. Follow-up in 3 months'),
-- (1, '2024-07-01', 'Visit', 'Cardiology', 'Medication review: Aspirin 81mg, Atorvastatin 80mg, Apixaban 2.5mg BID, Metoprolol 50mg, Fenofibrate 145mg', 'Polypharmacy management', 'Deprescribed: Fenofibrate (improved triglycerides). Added: CoQ10 200mg daily for statin myalgia prophylaxis');
